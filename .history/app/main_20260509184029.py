...
app=FastAPI(
    ...
    This system simulates student movement across campus zones using RFID readers, processes events in real-time, and applies security rules to detect unauthorized access.",
    version="1.0.0"
)
