...
app=FASTAPI(
    ...
    description= "A Real-Time RFID-Based Genfence Security Model for University Campuses. This system simulates student movement across campus zones using RFID readers, processes events in real-time, and applies security rules to detect unauthorized access.",
    version="1.0.0"
)
...
async def start_simulation(num_students: int=1000, duration: int=3600):
    Endpoint to start simulation from browser or 
